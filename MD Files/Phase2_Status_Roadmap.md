...
5. **Firebase Template/App Settings Storage**: Currently only envelopes and transactions are saved to Firebase. Need to implement Firebase storage for distribution templates and app settings (theme preferences, user preferences, etc.) to enable full cloud backup/restore functionality.
